...
if(strpos($message, "/rand")===0 or strpos($message, "!rand")===0 or strpos($message, ".rand")===0)
{
    ...
    $respo = urlencode("<b>
    •• ADDRESS GENERATOR
    • NOMBRE: <code>$first</code>
    • APELLIDOS: <code>$last</code>
    • DIRECCION: <code>$street</code>
    • CIUDAD: <code>$city</code>
    • ESTADO: <code>$state1</code>-<code>$state</code>
    • ZIP: <code>$zip</code>
    • PAIS: <code>$con</code>
    • SSN: <code>$ssn</code>
    • DOB: <code>$dob</code>
    • GENERO: <code>$gender</code>
    ----------------------------------------
    EMAIL: <code>$email</code>
    TELEFONO: <code>$phone</code>
    CELULAR: <code>$cell</code>
    USUARIO: <code>$usrnme</code>
    CONTRASEÑA: <code>$salt$pwd</code></b>");
...
CELULAR: <code>$cell</code>
USUARIO: <code>$usrnme</code>
CONTRASEÑA: <code>$salt$pwd</code>

<b>Dia:$date1</b></b>",
        'parse_mode'=>'html',
        'reply_markup'=>json_encode(['inline_keyboard'=>[
            [['text'=>"⬅️Back",'callback_data'=>"backme3"]],
            ],'resize_keyboard'=>true]),
        'disable_web_page_preview'=>'true'
    ]);
    // reply_to2($chat_id,$messageidtoedit,$keyboard,$respo);
}
if($data == "backme3"){
    bot('editMessageText',[
